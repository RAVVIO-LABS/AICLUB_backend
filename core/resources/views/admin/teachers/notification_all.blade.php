                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <small class="text--info d-none userCountText"> <i class="las la-info-circle"></i> <strong
                                            class="userCount">0</strong> @lang('active teachers found to send the notification')</small>
                                </div>
                                    ...
                                    <div class="col-md-4 start-from-col">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="start" value="{{ old('start', @$sessionData['start']) }}"
                                                type="number" placeholder="@lang('Start form teacher id. e.g. 1')" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" name="batch" value="{{ old('batch', @$sessionData['batch']) }}"
                                                    type="number" placeholder="@lang('How many teacher')" required>
    ...
    <script>
        ...
        (function($) {
            ...
            $('select[name=being_sent_to]').on('change', function(e) {
                ...
                if (methodName == 'SELECTEDINSTRUCTORS') {
                    ...
                    <div class="form-group" id="user_list_wrapper">
                        <label class="required">@lang('Select Teacher')</label>
                ...
                $('.row #user_list').select2({
                    ajax: {
                        ...
                        processResults: function(response, params) {
                            ...
                            let data = response.teachers.data;
                            return {
            ...
            function getUserCount(methodName) {
                ...
                var route = "{{ route('admin.teachers.segment.count', ':methodName') }}"
