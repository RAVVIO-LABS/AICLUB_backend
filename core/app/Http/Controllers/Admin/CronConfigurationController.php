...
class CronConfigurationController extends Controller
{
    public function cronJobs()
    {
        ...
        $serverCronCommand = '*/30 * * * * cd /var/www/html/core && /usr/bin/php artisan schedule:run >> /dev/null 2>&1';

        return view('admin.cron.index', compact('pageTitle', 'crons', 'schedules', 'serverCronCommand'));
    }
