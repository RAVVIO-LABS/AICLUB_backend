        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">@lang('Pending Teacher Approvals')</h5>
                </div>
                                ...
                                @forelse($teachers as $teacher)
                                    <tr>
                                        <td>
                                            ...
                                            <br>
                                            <span class="small">
                                                <a href="{{ route('admin.teachers.detail', $teacher->id) }}"><span>@</span>{{ $teacher->username }}</a>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="fw-bold" title="{{ @$teacher->country_name }}">{{ $teacher->country_code }}</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">{{ $teacher->courses_count }} @lang('Courses')</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">{{ $teacher->performance_stats['assigned_students'] ?? 0 }}</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">{{ $teacher->performance_stats['trial_classes'] ?? 0 }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="fw-bold">{{ showAmount($teacher->total_earnings_amount ?? 0) }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="fw-bold">{{ showAmount($teacher->balance) }}</span>
                                        </td>
                                        <td>
