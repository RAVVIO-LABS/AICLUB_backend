...
class ProcessController extends Controller
{
    ...
    public function ipn(Request $request)
    {
        ...
        $merchantAuthentication->setName(self::credentialValue($credentials, 'login_id'));
        $merchantAuthentication->setTransactionKey(self::credentialValue($credentials, 'transaction_key'));
