            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <div class="justify-content-between d-flex flex-wrap mb-1">
                        ...
                        <small class="text-muted d-block mb-1">@lang('Server Cron Command')</small>
                        <small class="fst-italic">
                            @lang('Last Cron Run'): <strong>{{ gs('last_cron') ? diffForHumans(gs('last_cron')) : 'N/A' }}</strong>
                        </small>
                    </div>
                    <div class="input-group">
                        <input type="text" class="form-control form-control-lg" id="cronPath" value="*/30 * * * * cd /var/www/html/core && /usr/bin/php artisan schedule:run >> /dev/null 2>&1" readonly>
