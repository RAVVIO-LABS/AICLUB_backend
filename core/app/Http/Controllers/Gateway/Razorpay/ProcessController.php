...
class ProcessController extends Controller
{
    ...
    public static function process($deposit)
    {
        ...
        $api_key = self::credentialValue($razorAcc, 'key_id');
        $api_secret = self::credentialValue($razorAcc, 'key_secret');
    ...
    public function ipn(Request $request)
    {
        ...
        $sig = hash_hmac('sha256', $orderId . "|" . $request->razorpay_payment_id, self::credentialValue($razorAcc, 'key_secret'));
